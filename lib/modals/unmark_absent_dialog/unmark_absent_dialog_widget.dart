...
import 'unmark_absent_dialog_model.dart';
export 'unmark_absent_dialog_model.dart';

class UnmarkAbsentDialogWidget extends StatefulWidget {
  const UnmarkAbsentDialogWidget({
    super.key,
  ...
  @override
  State<UnmarkAbsentDialogWidget> createState() =>
      _UnmarkAbsentDialogWidgetState();
}

class _UnmarkAbsentDialogWidgetState extends State<UnmarkAbsentDialogWidget> {
  late UnmarkAbsentDialogModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UnmarkAbsentDialogModel());
                ...
                child: RichText(
                  ...
                  text: TextSpan(
                    children: [
                      TextSpan(
                        text:
                            'You\'re about to remove the absence for this class.\n',
                      ...
                      TextSpan(
                        text:
                            'Attendrix will treat this class as present once the absence is removed.\n',
                        style: GoogleFonts.outfit(
                          color: FlutterFlowTheme.of(context).primaryText,
                          fontWeight: FontWeight.w600,
                          fontSize: 10.0,
