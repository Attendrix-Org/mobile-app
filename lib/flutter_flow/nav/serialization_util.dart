  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case AbsencesRow:
            return AbsencesRow(data);
          case AcademicCalendarEventsRow:
            return AcademicCalendarEventsRow(data);
          case AchievementProgressRow:
            return AchievementProgressRow(data);
          case AchievementTemplatesRow:
            return AchievementTemplatesRow(data);
          case AdminAuditLogRow:
            return AdminAuditLogRow(data);
          case AmplixLedgerRow:
            return AmplixLedgerRow(data);
          case ApodRow:
            return ApodRow(data);
          case AppVersionControlRow:
            return AppVersionControlRow(data);
          case AuditLogRow:
            return AuditLogRow(data);
          case BatchCoursesRow:
            return BatchCoursesRow(data);
          case BatchesRow:
          ...
          case ChallengeProgressClassesRow:
            return ChallengeProgressClassesRow(data);
          case ChallengeTemplatesRow:
            return ChallengeTemplatesRow(data);
          case ClassCancellationReportsRow:
            return ClassCancellationReportsRow(data);
          case ClassesRow:
            return ClassesRow(data);
          case CourseSyllabiRow:
            return CourseSyllabiRow(data);
          case CoursesRow:
            return CoursesRow(data);
          case DepartmentSemesterRulesRow:
            return DepartmentSemesterRulesRow(data);
          case DepartmentsRow:
            return DepartmentsRow(data);
          case ElectiveCoursesRow:
            return ElectiveCoursesRow(data);
          case ElectiveOfferingSemestersRow:
          ...
          case MessesRow:
            return MessesRow(data);
          case OauthStatesRow:
            return OauthStatesRow(data);
          case PgStatStatementsRow:
          ...
          case UserCalendarEventsRow:
            return UserCalendarEventsRow(data);
          case UserGoogleIntegrationsRow:
