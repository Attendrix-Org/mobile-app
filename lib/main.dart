...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    userStream = attendrixSupabaseUserStream()
      ..listen((user) {
      ...
      bottomNavigationBar: Container(
        ...
        child: SafeArea(
          child: GNav(
            ...
            tabBackgroundColor: FlutterFlowTheme.of(context).velvetSky,
            tabBorderRadius: 48.0,
            tabMargin: EdgeInsetsDirectional.fromSTEB(0.0, 14.0, 0.0, 12.0),
            ...
            tabs: [
              ...
              GButton(
                icon:
                    currentIndex == 1 ? FFIcons.kchartDots : FFIcons.kchartDots,
                text: 'Attendance',
                textStyle: GoogleFonts.outfit(
                  color: FlutterFlowTheme.of(context).info,
                  fontWeight: FontWeight.w600,
