                            ...
                            children: [
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'DASHBOARD_PAGE_Container_xz0a8bc3_ON_TAP');
                              ...
                              Flexible(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    await launchURL(
                                        'ims.nitc.ac.in/default/pages/portal/portalinfrastructure.html');
                                  },
                                  text: 'IMS Portal',
                                  icon: Icon(
                                    FFIcons.kbooks,
                              ...
                              Flexible(
                                ...
                                child: Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'DASHBOARD_PAGE_EDU_SERVER_BTN_ON_TAP');
                                      logFirebaseEvent('Button_launch_u_r_l');
                                      await launchURL('eduserver.nitc.ac.in');
                                    },
                                    text: 'EduServer',
                                    icon: Icon(
