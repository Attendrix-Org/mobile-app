// Export pages
export '/user_onboarding/forgot_password/forgot_password_widget.dart'
    show ForgotPasswordWidget;
export '/user_onboarding/reset_password/reset_password_widget.dart'
    show ResetPasswordWidget;
export '/user_onboarding/login/login_widget.dart' show LoginWidget;
export '/user_onboarding/create_account/create_account_widget.dart'
    show CreateAccountWidget;
export '/dashboard/dashboard_widget.dart' show DashboardWidget;
export '/user_onboarding/onboarding/onboarding_widget.dart'
    show OnboardingWidget;
export '/manage_classes/manage_classes_widget.dart' show ManageClassesWidget;
