...
import 'how_attendrix_shows_bus_timings_model.dart';
export 'how_attendrix_shows_bus_timings_model.dart';
...
class HowAttendrixShowsBusTimingsWidget extends StatefulWidget {
  const HowAttendrixShowsBusTimingsWidget({super.key});

  @override
  State<HowAttendrixShowsBusTimingsWidget> createState() =>
      _HowAttendrixShowsBusTimingsWidgetState();
}

class _HowAttendrixShowsBusTimingsWidgetState
    extends State<HowAttendrixShowsBusTimingsWidget> {
  late HowAttendrixShowsBusTimingsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HowAttendrixShowsBusTimingsModel());
                          ...
                          Padding(
                            ...
                            child: Container(
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    'How Attendrix Shows Bus Timings',
                                              ...
                                              Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 2.0, 0.0, 0.0),
                                                child: Text(
                                                  'Bus timings are based on the latest schedules available to Attendrix. Actual timings may vary due to traffic, weather, or operational changes.',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                                                      .override(
                                  ...
                                  FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'HOW_ATTENDRIX_SHOWS_BUS_TIMINGS_GOT_IT_B');
