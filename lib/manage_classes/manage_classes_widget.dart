...
class _ManageClassesWidgetState extends State<ManageClassesWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      logFirebaseEvent('manageClasses_custom_action');
      _model.upcomingClassesList = await actions.executeScheduleQuery(
        ScheduleViewType.upcoming,
        getCurrentTimestamp,
        getCurrentTimestamp,
        getCurrentTimestamp,
        10,
                        ...
                        children: [
                                  ...
                                  children: [
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        ...
                                        context
                                            .goNamed(DashboardWidget.routeName);
                                      },
                                      child: Icon(
                                        FFIcons.karrowBack,
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: Builder(
                                builder: (context) {
                                  final dateRangeRowView = _model.generatedDates
                                      .toList()
                                      .take(30)
                                      .toList();
                                  ...
                                  return SingleChildScrollView(
                                    ...
                                    child: Row(
                                      mainAxisSize: MainAxisSize.max,
                                      children:
                                          List.generate(dateRangeRowView.length,
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: FutureBuilder<List<CoursesRow>>(
                                          future: _model.userCourses(
                                            uniqueQueryKey:
                                                FFAppState().userProfile.userId,
                                            requestFn: () =>
                                                CoursesTable().queryRows(
                                ...
                                builder: (context) => Column(
                                  ...
                                  children: [
                                    ...
                                    if (dateTimeFormat(
                                      ...
                                      Builder(
                                        builder: (context) {
                                          final selectedClassesListView = _model
                                              .selectedDayClasses
                                              .toList()
                                              .take(10)
                                              .toList();
                                          ...
                                          return ListView.builder(
                                            ...
                                            itemCount:
                                                selectedClassesListView.length,
                                            itemBuilder: (context,
                                                selectedClassesListViewIndex) {
                                              final selectedClassesListViewItem =
                                                  selectedClassesListView[
                                                      selectedClassesListViewIndex];
                                              return Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                ...
                                                child: InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'MANAGE_CLASSES_Container_giqusnuo_ON_TAP');
                                                    logFirebaseEvent(
                                                        'classBlock_general_bottom_sheet');
                                                  ...
                                                  child: wrapWithModel(
                                                    ...
                                                    child:
                                                      ...
                                                      key: Key(
                                                        'Keygiq_${selectedClassesListViewItem.classId}',
                                                      ),
                                                      classBlock:
                                                          selectedClassesListViewItem,
                                                    ),
                                    ...
                                    Builder(
                                      builder: (context) {
                                        final todayClassesListView = _model
                                            .todayClasses
                                            .toList()
                                            .take(10)
                                            .toList();
                                        ...
                                        return ListView.builder(
                                          ...
                                          scrollDirection: Axis.vertical,
                                          itemCount:
                                              todayClassesListView.length,
                                          itemBuilder: (context,
                                              todayClassesListViewIndex) {
                                            final todayClassesListViewItem =
                                                todayClassesListView[
                                                    todayClassesListViewIndex];
                                            return Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(6.0, 0.0, 6.0, 2.0),
                                              child: InkWell(
                                                splashColor: Colors.transparent,
                                                focusColor: Colors.transparent,
                                                hoverColor: Colors.transparent,
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'MANAGE_CLASSES_Container_gakvwsut_ON_TAP');
                                                  logFirebaseEvent(
                                                      'classBlock_general_bottom_sheet');
                                                  await showModalBottomSheet(
                                                    isScrollControlled: true,
                                                ...
                                                child: wrapWithModel(
                                                  ...
                                                  child:
                                                      ClassBlockGeneralWidget(
                                                    key: Key(
                                                      'Keygak_${todayClassesListViewItem.classId}',
                                                    ),
                                                    classBlock:
                                                        todayClassesListViewItem,
                                                  ),
                                    ...
                                    Builder(
                                      builder: (context) {
                                        final upcomingClassesListView = _model
                                            .upcomingClasses
                                            .toList()
                                            .take(10)
                                            .toList();
                                        ...
                                        return ListView.builder(
                                          ...
                                          scrollDirection: Axis.vertical,
                                          itemCount:
                                              upcomingClassesListView.length,
                                          itemBuilder: (context,
                                            ...
                                            return Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'MANAGE_CLASSES_Container_2f00usmc_ON_TAP');
                                                  logFirebaseEvent(
                                                      'classBlock_general_bottom_sheet');
                                                  await showModalBottomSheet(
                                                    isScrollControlled: true,
                                                ...
                                                child: wrapWithModel(
                                                  ...
                                                  child:
                                                      ClassBlockGeneralWidget(
                                                    key: Key(
                                                      'Key2f0_${upcomingClassesListViewItem.classId}',
                                                    ),
                                                    classBlock:
                                                        upcomingClassesListViewItem,
                                                  ),
