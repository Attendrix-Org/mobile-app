...
void main() {
  ...
  group('CreateAccountScreen Tests', () {
    ...
    testWidgets('Password Criteria Helper - appears on focus and updates in real-time', (tester) async {
      await tester.pumpWidget(buildTestWidget());
      await tester.pumpAndSettle();
      ...
      final crossFadeShort = tester.widget<AnimatedCrossFade>(find.byType(AnimatedCrossFade));
      ...
      final crossFadeLong = tester.widget<AnimatedCrossFade>(find.byType(AnimatedCrossFade));
      ...
      final crossFadeAfter = tester.widget<AnimatedCrossFade>(find.byType(AnimatedCrossFade));
      expect(crossFadeAfter.crossFadeState, CrossFadeState.showSecond);
    });

    testWidgets('Form Validation - validation errors, mismatches, and submissions', (tester) async {
      await tester.pumpWidget(buildTestWidget());
      await tester.pumpAndSettle();
    ...
    testWidgets('Interactive State - toggles password and confirm password visibility', (tester) async {
      ...
      expect(getTextField(tester, passwordFinder).obscureText, isFalse);
      expect(getTextField(tester, confirmPasswordFinder).obscureText, isFalse);
    });
  });
}
